...
// var connect = function(sourceShape, sourcePort, targetShape, targetPort) {
...
//                         },
//                         text: {
//                             text: cxn.data.toString(),
//                             'font-style': italic
//                         }
//                     }
//                 }),
//                 rank: 0,
//                 path: 'data[' + nfGraph.data.length + ']'
//             };
//             connect(data.shape, 'out', nfGraph.processes[connection.tgt.process], connection.tgt.port);
//             nfGraph.processes[connection.tgt.process].rank = nfGraph.processes[connection.tgt.process].rank || 1;
//             nfGraph.data.push(data);
//         } else if (cxn.src) {
//             setRanksAndConnect(cxn, nfGraph);
//         } else {
